...
FAST_MODEL = os.getenv("CSS_FAST_MODEL", "gpt-5-nano")
STRONG_MODEL = os.getenv("CSS_STRONG_MODEL", "gpt-5.1")
ALLOW_STRONG_MODEL = os.getenv("CSS_ALLOW_STRONG_MODEL", "false").lower() == "true"
OPENAI_TIMEOUT_SECONDS = float(os.getenv("CSS_OPENAI_TIMEOUT_SECONDS", "55"))
OPENAI_MAX_OUTPUT_TOKENS = int(os.getenv("CSS_OPENAI_MAX_OUTPUT_TOKENS", "650"))
OPENAI_REASONING_EFFORT = os.getenv("CSS_OPENAI_REASONING_EFFORT", "minimal")
